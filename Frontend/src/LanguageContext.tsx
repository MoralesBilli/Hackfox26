...
const translations: Record<Language, Record<string, string>> = {
    es: {
        ...
        profile_citizen_level: 'Nivel\nCiudadano',
        profile_recent_reports: 'Mis reportes recientes',
        profile_config: 'Configuración',
        ...
        // Report Screen
        report_title: 'Reportar barrera',
        report_subtitle: 'Ayuda a mejorar la accesibilidad de nuestra ciudad reportando obstáculos.',
        report_photo: 'Foto de la barrera',
        report_tap_photo: 'Toca para subir foto o tomar foto',
        report_gemini_analyzing: 'Gemini analizará la foto automáticamente',
        report_type: 'Tipo de barrera',
        report_type_broken_sidewalk: 'Banqueta rota',
        report_type_no_ramp: 'Sin rampa',
        report_type_obstacle: 'Obstáculo',
        report_type_parked_car: 'Vehículo estacionado',
        report_location: 'Ubicación de la barrera',
        report_use_current_loc: 'Usar mi ubicación actual',
        report_obtaining_loc: 'Obteniendo ubicación...',
        report_desc: 'Descripción detallada',
        report_desc_placeholder: 'Describe el obstáculo, estado de la banqueta, rampa, etc.',
    ...
    en: {
        ...
        profile_citizen_level: 'Citizen\nLevel',
        profile_recent_reports: 'My recent reports',
        ...
        // Report Screen
        report_title: 'Report barrier',
        report_subtitle: 'Help improve accessibility in our city by reporting obstacles.',
        report_photo: 'Barrier photo',
        report_tap_photo: 'Tap to upload photo or take photo',
        report_gemini_analyzing: 'Gemini will automatically analyze the photo',
        report_type: 'Barrier type',
        report_type_broken_sidewalk: 'Broken sidewalk',
        report_type_no_ramp: 'No ramp',
        report_type_obstacle: 'Obstacle',
        report_type_parked_car: 'Parked vehicle',
        report_location: 'Barrier location',
        report_use_current_loc: 'Use my current location',
        report_obtaining_loc: 'Getting location...',
        report_desc: 'Detailed description',
        report_desc_placeholder: 'Describe the obstacle, condition of the sidewalk, ramp, etc.',
